...
@Description(name = "Field (RED)", dataTypes = FieldData.class)
@SuppressWarnings({"EmptyCatchBlock", "PMD.TooManyFields"})
@ParametrizedController("FieldWidgetRed.fxml")
public class FieldWidgetRed extends SimpleAnnotatedWidget<FieldData> {
  @FXML
  private Pane root;
